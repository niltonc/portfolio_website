    ...
    <main>
      <section id="testimonial">
        ...
        <div className="testimonial-card">
          ...
          <h4>
            Tanmoy was a real pleasure to work with and we look forward to
        ...
        <div className="testimonial-card" style={{ display: 'none' }}>
          ...
          <h4>
            Working with Tanmoy was a pleasure. Their expertise in both design
        ...
        <div className="testimonial-card" style={{ display: 'none' }}>
          ...
          <h4>
            I highly recommend Tanmoy for any design or development project.
